...
if not groq_api_key:
    print("Warning: GROQ_API_KEY not found in environment variables. LLM explanations will be disabled.")
    groq_client = None
else:
...
"""
    ...
    if groq_client is None:
        llm_output = "LLM explanation unavailable - GROQ_API_KEY not configured. Please set the environment variable to enable AI-powered explanations."
    else:
